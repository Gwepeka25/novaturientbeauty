...
import {
  ...
  getDigitalResourcePurchaseRevenueRowsForExport,
...
export async function GET(request: NextRequest) {
  ...
  const [revenue, expenses, packageSales, giftCodeSales, workshopRegistrations, digitalResourcePurchases] = await Promise.all([
    ...
    getDigitalResourcePurchaseRevenueRowsForExport(resolveReportRange(preset)),
  ]);
